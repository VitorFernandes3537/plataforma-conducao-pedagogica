 ...
 */
export async function liberaAgregadoAction(dados: { blocoId: string; diaId: string }) {
  ...
  // A conferência de papel acontece de novo dentro de `liberaAgregado`. Aqui ela
  // existe para falhar cedo e com frase, não para ser a única (ADR 0001 §3).
